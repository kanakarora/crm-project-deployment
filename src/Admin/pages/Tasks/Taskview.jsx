        ...
        <>
            <div className="w-[100%] flex px-4 view-not mx-4 mt-2">
                <div className="w-[60%] p-[20px] h-[100%] overflow-scroll ">
                    <div className="flex justify-between mb-[20px]">
                        ...
                        <div className="relative  flex justify-end items-center">
                            ...
                            {/* Dropdown menu */}
                            {isOpen1 && (
                                <div className="absolute w-[200px] z-10 mt-2  right-[0px] top-[27px] left-[-182px] bg-white border border-gray-200 rounded-md shadow-lg">
                    ...
                    <div className="mb-[20px]">
                        <div className="w-[60%] mb-[10px] flex justify-between items-center" >
                ...
                <div className="w-[40%] bg-[#f5f8fa] fixed right-[-68px] h-[530px] p-[20px]">
                    ...
                    <div className="flex justify-end flex-col h-[400px] ">
