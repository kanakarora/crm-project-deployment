...
const Task = () => {
    ...
    const accordionItems = [
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="flex p-[0]">
                                ...
                                <td className="p-[10px] w-[108px]"><Link className="text-[10px]  text-[#47cc00] " >Complete</Link></td>

                                <td className="text-[12px] w-[40px] font-medium p-[10px] text-[#2563eb] hover:text-blue-950">43</td>



        <td onClick={() => navigate('/taskview')} className="flex flex-col w-[250px] p-[10px] break-words">
        <p  className="text-[11px] text-[#2563eb]">soul relation intro</p>
        <p className="text-[9px] text-[#000]"> #12 - DIVINE HEALING-AUG-2024 - DIVINE HEALING</p>
     </td>
        ...
        <p className="text-[11px] text-[#2563eb]" onClick={() => navigate("/taskview")}>URBAN KHALSA REEL</p>
        <p className="text-[9px] text-[#000]" to="/">#8 - URBAN KHALSA - URBAN KHALSA</p>
        </td>
