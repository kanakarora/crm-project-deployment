        ...
        <div className=" w-full absolute pl-[140px] top-[95px] right-[5px] ">
            ...
            <div className="bg-[#fff] p-[10px] pl-[100px]">
                <div className="mb-[14px]">
                    ...
                    <Link to="/addnewtask" className="text-[#fff] text-[14px] bg-[#8a25b0] mb-[10px]  focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg  p-[8px] text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
