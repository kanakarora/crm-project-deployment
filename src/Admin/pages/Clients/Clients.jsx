...
const Clients = () => {
            ...
            <thead>
              <tr>
                <th className="border-r">
                  <input
                    className="text-[12px] h-[12px] font-medium p-[10px] w-[30px]  whitespace-nowrap"
                    type="checkbox"
                  />
                </th>

                <th className="text-[11px] border-r w-[50px]  font-medium p-[10px] ">
                  #
                </th>

                <th className="text-[11px] w-[180px] p-[10px] border-r font-medium whitespace-nowrap">
                  Company
                </th>

                <th className="text-[11px] font-medium p-[10px] w-[130px] border-r whitespace-nowrap	">
                  Primary Contact
                </th>
                ...
                <th className="text-[11px] font-medium p-[10px] w-[80px] border-r whitespace-nowrap	">
                  Phone
                </th>
                <th className="text-[11px] font-medium p-[10px] w-[80px] border-r whitespace-nowrap	">
                  Active
        ...
        <table className="w-full ">
          <tbody>
            <tr>
              ...
              <td className="text-[11px]  w-[50px]  font-medium p-[10px] ">
                19
              </td>

              <td className="text-[11px] w-[180px] p-[10px]  font-medium whitespace-nowrap">
                ABJEETGE
              </td>
  ...
  return (
    <div className=" w-full   top-[95px] right-[5px] mt-4">
      <div className="bg-[#fff] p-[10px] ">
        <div className="mb-[14px] flex gap-[10px] items-center">
          <Link
            to="/addnewclient"
            className="text-[#fff] text-[14px] bg-[#8a25b0]  focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg  p-[8px] text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            <AddIcon className="newadd" /> New Client
          </Link>
          <Link
            to="/"
            className="text-[#fff] text-[14px] bg-[#8a25b0]   focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg  p-[8px] text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            <AddIcon className="newadd" /> Import Customers
          </Link>
          <Link
            to="/"
            className="text-[#000] text-[14px] bg-[#f4f2f2]  focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg  p-[8px] text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
